            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card" style="position: relative; left: 45%;">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title">Test Scores</h4>
                                ...
                                <div class="card-body table-responsive">
                                    <div style="padding:4%">
                                        <table class="table table-hover">
                                            <thead class="text-primary">
                                                <th style="text-align-left">Question No</th>
                                                <th>Score</th>
                                    ...
                                    <a href="quiz.php"><button type="submit" name="submit" class="btn btn-success pull-right">Finish Test</button></a>
